...
VALUES
  (
    $1,$2,$3
  ) RETURNING id, from_account_id, to_acount_id, amount, created_at
`
...
func (q *Queries) CreateTransfer(ctx context.Context, arg CreateTransferParams) (Transfer, error) {
	row := q.queryRow(ctx, q.createTransferStmt, createTransfer, arg.FromAccountID, arg.ToAcountID, arg.Amount)
	var i Transfer
	err := row.Scan(
		&i.ID,
		&i.FromAccountID,
...
SELECT id, from_account_id, to_acount_id, amount, created_at FROM transfers
WHERE id = $1 LIMIT 1
`
